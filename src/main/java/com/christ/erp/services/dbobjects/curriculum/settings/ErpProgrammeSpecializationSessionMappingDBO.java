...
@Entity
@Table(name = "erp_programme_specialization_session_mapping")
@Getter
@Setter
public class ErpProgrammeSpecializationSessionMappingDBO implements Serializable {
	private static final long serialVersionUID = 3722455250633061387L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "erp_programme_specialization_session_mapping_id")
	private int id; 
